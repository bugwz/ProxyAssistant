const translations = {
  "zh-CN": {
    ...
    "end_time": "结束时间",
    "sync_settings": "同步设置",
    "auto_sync_desc": "在相同 Google 账户的浏览器间同步代理数据 (默认开启)",
  ...
  "zh-TW": {
    ...
    "end_time": "結束時間",
    "sync_settings": "同步設定",
    "auto_sync_desc": "在相同 Google 帳戶的瀏覽器間同步代理數據 (預設開啟)",
    "config_management": "配置管理",
    "config_desc": "管理系統配置",
    "export_config": "匯出配置",
    "import_config": "匯入配置",
  ...
  "en": {
    ...
    "auto_sync_desc": "Sync proxy data across browsers with the same Google account (Enabled by default)",
  ...
  "ja": {
    ...
    "end_time": "終了時間",
    "sync_settings": "同期設定",
    "auto_sync_desc": "同じGoogleアカウントのブラウザ間でプロキシデータを同期します（デフォルトで有効）",
  ...
  "fr": {
    ...
    "auto_sync_desc": "Synchroniser les données proxy entre les navigateurs avec le même compte Google (Activé par défaut)",
