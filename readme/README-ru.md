...
### 1.4 📋 Гибкая настройка правил URL
...
### 1.7 🏃 Определение состояния прокси
...
### 1.10 ☁️ Хранение и синхронизация данных

#### 1.10.1 Стратегия хранения

| Тип хранилища | Описание |
|--------------|----------|
| **Локальное хранилище (local)** | Всегда активно, хранит список прокси и все данные конфигурации, обеспечивая автономную доступность |
| **Облачная синхронизация (sync)** | Опциональная функция, синхронизирует между несколькими устройствами с одной учетной записью браузера |

#### 1.10.2 Методы синхронизации

##### 1.10.2.1 Родная синхронизация браузера (Native Sync)
- Использует API `chrome.storage.sync`
...
##### 1.10.2.2 Синхронизация GitHub Gist
...
### 5.3 Автоматический режим с PAC-скриптом
...
### 5.5 Импорт/экспорт конфигурации
...
### 5.6 Определение состояния прокси
...
### 7.1 Сценарий 1: Переключение между несколькими прокси
