const translations = {
  "zh-CN": {
    ...
    "proxy_detection_source": "检测来源",
    "proxy_source_browser_api": "浏览器代理 API",
    "proxy_source_http_test": "HTTP 请求测试",
    "proxy_mode": "代理模式",
    "proxy_server": "服务器地址",
    "proxy_protocol": "代理协议",
    "proxy_control": "控制权",
  ...
  "zh-TW": {
    ...
    "proxy_detection_source": "檢測來源",
    "proxy_source_browser_api": "瀏覽器代理 API",
    "proxy_source_http_test": "HTTP 請求測試",
    "proxy_mode": "代理模式",
    "proxy_server": "伺服器地址",
    "proxy_protocol": "代理協議",
    "proxy_control": "控制權",
  ...
  "en": {
    ...
    "proxy_detection_source": "Detection Source",
    "proxy_source_browser_api": "Browser Proxy API",
    "proxy_source_http_test": "HTTP Request Test",
  ...
  "ja": {
    ...
    "proxy_detection_source": "検出元",
    "proxy_source_browser_api": "ブラウザプロキシ API",
    "proxy_source_http_test": "HTTPリクエストテスト",
    "proxy_mode": "プロキシモード",
  ...
  "fr": {
    ...
    "proxy_detection_source": "Source Détection",
    "proxy_source_browser_api": "API Proxy Navigateur",
    "proxy_source_http_test": "Test Requête HTTP",
  ...
  "de": {
    ...
    "proxy_detection_source": "Erkennungsquelle",
    "proxy_source_browser_api": "Browser Proxy API",
    "proxy_source_http_test": "HTTP Anfrage Test",
  ...
  "es": {
    ...
    "proxy_detection_source": "Fuente Detección",
    "proxy_source_browser_api": "API Proxy Navegador",
    "proxy_source_http_test": "Prueba Solicitud HTTP",
  ...
  "ko": {
    ...
    "proxy_detection_source": "감지 소스",
    "proxy_source_browser_api": "브라우저 프록시 API",
    "proxy_source_http_test": "HTTP 요청 테스트",
    "proxy_mode": "프록시 모드",
    "proxy_server": "서버 주소",
  ...
  "pt": {
    ...
    "proxy_detection_source": "Fonte Detecção",
    "proxy_source_browser_api": "API Proxy Navegador",
    "proxy_source_http_test": "Teste Solicitação HTTP",
    "proxy_mode": "Modo Proxy",
  ...
  "ru": {
    ...
    "proxy_detection_source": "Источник Проверки",
    "proxy_source_browser_api": "API Прокси Браузера",
    "proxy_source_http_test": "Тест HTTP Запроса",
