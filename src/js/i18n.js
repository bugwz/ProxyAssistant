const translations = {
  "zh-CN": {
    ...
    "proxy_detection_desc": "检测当前系统代理配置，判断是否使用本插件",
  ...
  "zh-TW": {
    ...
    "proxy_detection_desc": "檢測當前系統代理配置，判斷是否使用本插件",
  ...
  "en": {
    ...
    "proxy_detection_desc": "Detect current system proxy configuration and check if using this extension",
  ...
  "ja": {
    ...
    "proxy_detection_desc": "現在のシステムプロキシ構成を検出し、この拡張機能を使用しているかどうかを確認します",
  ...
  "fr": {
    ...
    "proxy_detection_desc": "Détecter la configuration proxy du système actuel et vérifier si cette extension est utilisée",
  ...
  "de": {
    ...
    "proxy_detection_desc": "Erkennen Sie die aktuelle System-Proxy-Konfiguration und prüfen Sie, ob diese Erweiterung verwendet wird",
  ...
  "es": {
    ...
    "proxy_detection_desc": "Detectar la configuración proxy actual del sistema y verificar si está usando esta extensión",
  ...
  "ko": {
    ...
    "proxy_detection_desc": "현재 시스템 프록시 구성을 감지하고 이 확장 프로그램을 사용 중인지 확인합니다",
  ...
  "pt": {
    ...
    "proxy_detection_desc": "Detectar a configuração proxy atual do sistema e verificar se está usando esta extensão",
  ...
  "ru": {
    ...
    "proxy_detection_desc": "Определите текущую конфигурацию прокси системы и проверьте, используется ли это расширение",
